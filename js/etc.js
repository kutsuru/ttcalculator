...
,[36,"Voina Dagger","Physical Damage + 10%",1,1157,80,10,0]
,[37,"Roubel","Bash / Bowling Bash Damage + 20%",1,1158,5006,20,5076,20,0]
,[38,"Chronos","MATK + 12%, SP Cost + 20%",1,1172,72,20,89,12,0]
,[39,"Nemesis","ATK + 50",1,820,17,50,0]
,[40,"Sorin Doll Hat","ATK + 50",1,892,17,50,0]
,[41,"Sagittarius Diadem","+10 DEX/AGI",1,1288,2,10,5,10,0]
,[42,"Virgo Crown","+20 DEX",1,1294,5,20,0]
,[43,"Vinit Doll Hat","ASPD + 5%",1,1028,12,5,0]
,[44,"Dark Knight Glove[Type A]","ASPD + 2%",1,1052,12,2,0]
,[45,"Dark Knight Glove[Type B]","MHP + 10%",1,1310,15,10,0]
,[46,"Jaguar Hat","Loud Exclamation",1,1317,1,4,0] //custom Talon Tales, really?
,[47,"Djinn","40% damage reflection",1,1380,71,40,0] //custom Talon Tales
,[48,"Chicken Hat","Loud Exclamation",1,1422,1,4,0] //custom Talon Tales
,[49,"Ancient Horns","ATK + 100",1,1538,17,100,0] //custom Talon Tales,
,[50,"Duneyrr Card","Perfect Dodge + 10, [Lord Knight] Additional + 10 under Berserk",2,511,0]
,[51,"Rhyncho Card","Increase Resistance to Fire property by 10%",2,513,63,10,0]
,[52,"Brindle Eel [Rental]","When long range attacking, has a chance of adding ASPD + 10% for 7 seconds.",1,1807,12,10,0]
,[53,"Saurel [Rental]","When using a melee attack, has a chance of adding ATK + 30 for 7 seconds.",1,1811,17,30,0]
,[54,"Saurel [Rental]","When doing a magical attack, has a chance of adding MATK + 10% for 7 seconds.",1,1811,89,10,0]
,[55,"Invective Robe", "Activate level 1 [Attention Concentrate].",1,1818,0]
,[56,"Valorous Assassin Damascus", "Enable Ice Pick effect.",1,898,23,1,0]
,[57,"Glorious Staff of Destruction", "MATK + 3% for each refine level for 6 seconds when using magic attacks at a 1% chance per refine.",1,1083,0]
,[58,"Illusion of Faceworm Queen", "Ignores 50% defense and 30% MDEF of Insect race monsters.",1,1875,184,50,314,30,0]
];
...
sqi_bonus_db = {
	...
	1385 : 	[["20% Magic Resistance",101,20,0]
			...
			,["[Final Strike] ignores enemy DEF. 10% of your current HP (not max) remains after using [Final Strike]",0]
			,["2 Cell Knockback and 50% more damage with [Crimson Fire Formation]",5408,50,0]
			,["50% more damage with [Throw Humma Shuriken], [Throw Shuriken], and [Throw Kunai]",5394,50,5395,50,5396,50,0]
...
//GameID, 1=HP 0=SP, MinHeal, MaxHeal, Name, Weight, Vanilla=1 Unres=0, 0=HealAmnt 1=Healby%, 1=CanBeRanked
ITEM_HEAL = [
		[517,1,70,100,"Meat",2,0,0,0]
		,[547,1,325,405,"Condensed White Potion",1,0,0,1]
		,[533,0,15,25,"Grape Juice",0.5,0,0,0]
		,[575,1,270,330,"2nd Anniversary Cake",10,1,0,0]
		,[521,1,325,405,"Aloe Leaflet",2,1,0,0]
		,[512,1,16,22,"Apple",2,1,0,0]
		,[531,1,25,35,"Apple Juice",4,1,0,0]
		,[577,1,60,70,"Bag of Grain",2,1,0,0]
		,[513,1,17,21,"Banana",2,1,0,0]
		,[532,1,26,34,"Banana Juice",4,1,0,0]
		,[553,1,35,70,"Bao",5,1,0,0]
		,[11519,1,170,250,"Beef Toast",4,1,0,0]
		,[20151,0,10,15,"BG Blue Potion",0,1,1,0]
		,[20150,1,475,600,"BG Red Potion",0,1,0,0]
		,[510,0,15,30,"Blue Herb",7,1,0,0]
		,[505,0,40,60,"Blue Potion",15,1,0,1]
		,[12034,0,9,9,"Box of Panting",20,1,1,0]
		,[580,1,50,90,"Bread",2,1,0,0]
		,[585,1,15,20,"Brusti",4,1,0,0]
		,[529,1,45,65,"Candy",3,1,0,0]
		,[530,1,105,145,"Candy Cane",4,1,0,0]
		,[515,1,18,20,"Carrot",2,1,0,0]
		,[534,1,27,33,"Carrot Juice",4,1,0,0]
		,[591,1,325,405,"Caviar Pancake",15,1,0,0]
		,[548,0,10,15,"Cheese",5,1,0,0]
		,[573,1,330,410,"Chocolate Drink",15,1,0,0]
		,[545,1,45,65,"Condensed Red Potion",1,1,0,1]
		,[546,1,175,235,"Condensed Yellow Potion",2,1,0,1]
		,[596,0,1,100,"Cute Strawberry-Choco",10,1,0,0]
		,[562,1,70,100,"Doublecrust Swiss Fondue",15,1,0,0]
		,[563,1,375,445,"Doublecrust Swiss Fondue",15,1,0,0]
		,[581,1,20,30,"Edible Mushroom",2,1,0,0]
		,[574,1,33,42,"Egg",3,1,0,0]
		,[540,1,185,225,"Falcon Food",5,1,0,0]
		,[21638,1,5,5,"Festie Cookie",5,1,1,0]
		,[584,1,40,70,"Fish Cake Soup",6,1,0,0]
		,[542,1,105,145,"Fortune Cookie",0,1,0,0]
		,[579,1,100,150,"Fresh Fish",2,1,0,0]
		,[12027,1,9,9,"Giggling Box",20,1,1,0]
		,[514,0,10,15,"Grape",0.1,1,0,0]
		,[12709,1,30,30,"Guyak Candy (HP)",15,1,1,0]
		,[12709,0,30,30,"Guyak Candy (SP)",15,1,1,0]
		,[21296,1,70,100,"Halloweenie (Base)",1,1,0,0]
		,[21296,1,105,150,"Halloweenie (During Oct/Nov)",1,1,0,0]
		,[520,1,175,235,"Hinalle Leaflet",1,1,0,0]
		,[518,1,70,100,"Honey",10,0,0,0]
		,[593,1,325,405,"Honey Pancake",15,1,0,0]
		,[536,1,105,145,"Ice Cream",8,1,0,0]
		,[592,1,325,405,"Jam Pancake",15,1,0,0]
		,[552,1,70,90,"Ketupat",1,1,0,0]
		,[583,1,325,405,"Ketupat Sayur",15,1,0,0]
		,[568,0,10,20,"Lemon",4,1,0,0]
		,[599,1,105,145,"Light Orange Potion",1,1,0,0]
		,[598,1,45,65,"Light Red Potion",1,1,0,0]
		,[597,1,10,400,"Lovely Choco-Tart",10,1,0,0]
		,[570,1,45,65,"Lucky Candy",3,1,0,0]
		,[571,1,105,145,"Lucky Candy Cane",4,1,0,0]
		,[572,1,160,200,"Lucky Cookie",3,1,0,0]
		,[522,1,400,600,"Mastela Fruit",3,1,0,0]
		,[21297,0,19,31,"Melodia Matchan (Base)",1,1,0,0]
		,[21297,0,24,39,"Melodia Matchan (During Oct/ Nov)",1,1,0,0]
		,[12271,1,5,5,"Military Ration A",7,1,1,0]
		,[519,1,27,37,"Milk",3,1,0,0]
		,[554,1,105,145,"Mochi",8,1,0,0]
		,[528,1,72,108,"Monster's Feed",15,1,0,0]
		,[586,1,325,405,"Mother's Cake",10,1,0,0]
		,[595,1,325,405,"Mushroom Pancake",15,1,0,0]
		,[557,1,25,30,"Neatly Sliced Rice Cake",1,1,0,0]
		,[569,1,22,33,"Novice Potion",1,1,0,0]
		,[582,1,10,20,"Orange",2,1,0,0]
		,[502,1,105,145,"Orange Potion",10,1,0,0]
		,[541,1,325,405,"PecoPeco Food",5,1,0,0]
		,[22701,1,40,40,"Pegasus Cotton Candy (HP)",5,1,1,0]
		,[22701,1,40,40,"Pegasus Cotton Candy (SP)",5,1,1,0]
		,[537,1,50,90,"Pet Food",1,1,0,0]
		,[539,1,270,330,"Piece of Cake",1,1,0,0]
		,[589,1,375,445,"Pizza",15,1,0,0]
		,[516,1,15,23,"Potato",2,1,0,0]
		,[590,1,50,90,"Pretzel",2,1,0,0]
		,[576,1,150,300,"Prickly Fruit",6,1,0,0]
		,[544,1,25,60,"Raw Fish",3,1,0,0]
		,[507,1,18,28,"Red Herb",3,1,0,0]
		,[501,1,45,65,"Red Potion",7,1,0,1]
		,[587,1,270,330,"Red Prickly Fruit",6,1,0,0]
		,[550,1,10,15,"Rice Cake",1,1,0,0]
		,[556,1,20,25,"Rice Cake Stick",1,1,0,0]
		,[526,1,325,405,"Royal Jelly",15,1,0,0]
		,[567,1,117,192,"Shrimp",4,1,0,0]
		,[11549,0,10,10,"Siege Blue Potion",5,1,1,0]
		,[11547,1,500,700,"Siege Violet Potion (HP)",12,1,0,0]
		,[11547,0,60,85,"Siege Violet Potion (SP)",12,1,0,0]
		,[11548,1,10,10,"Siege White Potion",5,1,1,0]
		,[594,1,325,405,"Sour-Cream Pancake",15,1,0,0]
		,[588,1,40,70,"Spaghetti",10,1,0,0]
		,[578,0,16,28,"Strawberry",2,1,0,0]
		,[551,1,50,60,"Sushi",5,1,0,0]
		,[566,1,244,350,"Tom Yum Goong",15,1,0,0]
		,[555,1,105,145,"Traditional Rice Cake",2,1,0,0]
		,[565,1,142,274,"Vita500",10,1,0,0]
		,[538,1,160,200,"Well-baked Cookie",3,1,0,0]
		,[509,1,75,115,"White Herb",7,1,0,0]
		,[504,1,325,405,"White Potion",15,1,0,1]
		,[11504,0,50,70,"WoE Blue Potion",5,1,0,0]
		,[11503,1,400,500,"WoE White Potion",2,1,0,0]
		,[549,1,50,100,"Yam",8,1,0,0]
		,[508,1,38,58,"Yellow Herb",5,1,0,0]
		,[503,1,175,235,"Yellow Potion",13,1,0,1]
		,[608,1,50,50,"Yggdrasil Seed (HP)",30,1,1,0]
		,[608,0,50,50,"Yggdrasil Seed (SP)",30,1,1,0]
];
